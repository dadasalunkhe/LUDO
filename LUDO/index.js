...
document.getElementById('name1').innerHTML = "xyz1 score: " +score1;
  document.getElementById('name2').innerHTML = "xyz2 score: " +score2;

  if(score1>50){
    document.getElementById('name1').innerHTML = "Winner:xyz1 score";
    document.getElementById('name2').innerHTML = "";
  }
  if(score2>50){
    document.getElementById('name1').innerHTML = "winner:xyz2 score";
   document.getElementById('name2').innerHTML = "";
  }
}
